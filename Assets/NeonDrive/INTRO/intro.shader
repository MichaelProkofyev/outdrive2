...
Shader "OutDrive/intro" {
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma target 3.0
            uniform sampler2D _Intro; uniform float4 _Intro_ST;
            struct VertexInput {
...
////// Lighting:
////// Emissive:
                float4 _Intro_var = tex2D(_Intro,TRANSFORM_TEX(i.uv0, _Intro));
                float3 emissive = _Intro_var.rgb;
