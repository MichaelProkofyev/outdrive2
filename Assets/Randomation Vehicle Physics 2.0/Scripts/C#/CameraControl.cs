...
public class CameraControl : MonoBehaviour
{
	...
	public float offsetCamF;
	public float speedMultF;

	public float hieghtMultF;
	float xInput;
	float yInput;
	...
	void FixedUpdate()
	{
		if (target && targetBody && target.gameObject.activeSelf)
		{
			...
			Vector3 localOffset = lookObj.TransformPoint(-lookDirActual * distance - lookDirActual * Mathf.Min(targetBody.velocity.magnitude * speedMultF, offsetCamF) + new Vector3(0,height*hieghtMultF,0));
